...
public class AlternatingIteratorTest {
	...
	public void testAllNullIterators() {
	    ...
	    thrown.expectMessage("Out Of Bounds - No Element Found");
	...
	public void testSomeNullIterators() {
		...
		AlternatingIterator<String> testIter = new AlternatingIterator<String>(null, list1.iterator(), null,
				list2.iterator(), null, list3.iterator());
	...
	public void testAllEmptyIterators() {
		...
		AlternatingIterator<String> testIter = new AlternatingIterator<String>(list1.iterator(), list2.iterator(),
				list3.iterator());
	...
	public void testSomeEmptyIterators() {
		...
		AlternatingIterator<String> testIter = new AlternatingIterator<String>(emptyList.iterator(), list1.iterator(),
				emptyList.iterator(), list2.iterator(), emptyList.iterator(), list3.iterator());
	...
	public void testIntegerHasNextAndNextMethods() {
		...
		AlternatingIterator<Integer> testIter = new AlternatingIterator<Integer>(list1.iterator(), list2.iterator(),
				list3.iterator());
