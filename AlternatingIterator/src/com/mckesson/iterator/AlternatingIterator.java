...
public class AlternatingIterator<T> implements Iterator<T>
{
	...
	{
		// The iterators that are passed in can not be used directly as the references will be modified the 
		// hasNext and Next methods so copies need to be made so we don't unexpectedly move an iterator 
	...
	public boolean hasNext()
	{
		...
		// loop until all the has next iterators and the item iterators have been exhausted
